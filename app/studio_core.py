...
OFFICIAL_RUNTIME_CONTROLS: dict[str, dict[str, Any]] = {
    ...
    "ACESTEP_VAE_CHECKPOINT": {"status": "supported", "ui_field": "vae_checkpoint"},
...
def _field_options(field: str) -> list[Any]:
    options: dict[str, list[Any]] = {
        ...
        "vocal_language": VALID_LANGUAGES,
        ...
        "vae_checkpoint": ["official", "scragvae"],
    }
...
def _field_note(field: str) -> str:
    notes = {
        ...
        "dcw_enabled": "Vendor 1.5 DCW wavelet-domain correction is available, but AceJAM keeps it off by default for stable MLX vocal renders.",
        ...
        "vae_checkpoint": "ACE-Step v0.1.7 service-init VAE selector. 'official' is bundled; 'scragvae' is auto-downloaded by ACE-Step on first use.",
    }
