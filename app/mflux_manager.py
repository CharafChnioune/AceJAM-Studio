...
MFLUX_MODELS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "edit_command": "mflux-generate-fibo-edit",
        "capabilities": ["generate", "edit", "vlm_refine"],
        "trainable": False,
        "description": "JSON-native base FIBO with structured-prompt control and the dedicated upstream edit command.",
    },
    {
        "id": "fibo-lite",
        "label": "FIBO Lite",
        ...
        "trainable": False,
        "model_arg": "fibo-lite",
        "description": "Distilled FIBO Lite draft path: fast few-step JSON-native generation with lower guidance.",
    },
    {
        "id": "ideogram4",
...
def _run_cli_job(job_id: str, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    metadata = {
        ...
        "guidance": payload.get("guidance") or model.get("default_guidance") or "",
