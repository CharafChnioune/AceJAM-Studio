...
import { LoraSweepWizard } from "@/wizards/LoraBenchmarkWizard";
...
function Sidebar() {
  const items = [
    ...
    { to: "/wizard/lora-benchmark", label: "LoRA Sweep", icon: BarChart3 },
      ...
      <div className="flex h-full min-h-0 w-full">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <Routes>
            ...
            <Route path="/wizard/lora-benchmark" element={<LoraSweepWizard />} />
