...
const optionalLooseRecord = z.record(z.string(), z.unknown()).default({});
...
export const simpleSchema = z.object({
  ...
  adapter_model_variant: z.string().default(""),
  adapter_song_model: z.string().default(""),
  genre_execution_contract: optionalLooseRecord,
  lyric_technique_report: optionalLooseRecord,
  lora_selection_reason: z.string().default(""),
  performance_notes: z.string().default(""),
  strict_completion_notes: z.string().default(""),
  single_art_negative_prompt: z.string().default(""),
  video_negative_prompt: z.string().default(""),
  payload_gate_status: z.string().default(""),
  payload_gate_passed: z.boolean().default(false),
  payload_gate_blocking_issues: z.array(z.string()).default([]),
  payload_quality_gate: optionalLooseRecord,
  rap_quality_report: optionalLooseRecord,
  rap_rewrite_status: z.string().default(""),
  rap_blocking_issues: z.array(z.string()).default([]),
  rap_strengths: z.array(z.string()).default([]),
  rap_revision_focus: z.array(z.string()).default([]),
...
export const customSchema = simpleSchema.extend({
  ...
  inference_steps: z.number().int().min(4).max(100).default(64),
...
export const albumTrackSchema = z.object({
  ...
  album_art_prompt: optionalString,
  album_art_negative_prompt: optionalString,
  single_art_prompt: optionalString,
  single_art_negative_prompt: optionalString,
  video_prompt: optionalString,
  video_negative_prompt: optionalString,
  visual_palette: optionalString,
  camera_motion: optionalString,
  no_text_policy: optionalString,
  ...
  lora_adapter_path: optionalString,
  use_lora: z.boolean().optional(),
  use_lora_trigger: z.boolean().optional(),
  ...
  ignored_lora_adapter_name: optionalString,
  ignored_lora_adapter_path: optionalString,
  ignored_lora_adapter_song_model: optionalString,
}).passthrough();
...
export const albumSchema = z.object({
  ...
  track_variants: z.number().int().min(1).max(8).default(4),
  ...
  auto_video_clip: z.boolean().default(false),
  art_prompt: z.string().default(""),
  album_art_prompt: z.string().default(""),
  album_art_negative_prompt: z.string().default(""),
  single_art_prompt: z.string().default(""),
  single_art_negative_prompt: z.string().default(""),
  video_prompt: z.string().default(""),
  video_negative_prompt: z.string().default(""),
  visual_palette: z.string().default(""),
  camera_motion: z.string().default(""),
  no_text_policy: z.string().default(""),
