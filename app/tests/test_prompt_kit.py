...
class PromptKitTest(unittest.TestCase):
    ...
    def test_genre_modules_and_payload_contract(self):
        ...
        self.assertEqual(len(PROMPT_KIT_OUTPUT_CONTRACT_FIELDS), 29)
        ...
        self.assertIn("rap_quality_report", PROMPT_KIT_OUTPUT_CONTRACT_FIELDS)
        ...
        self.assertIn("rap_quality_contract", payload)
    ...
    def test_metadata_defaults_and_system_block(self):
        ...
        self.assertEqual(meta["rap_blocking_issues"], [])
    ...
    def test_system_block_appends_acestep_full_reference_for_music_modes(self):
        ...
        self.assertIn("## Rap Quality Gate", block)
        ...
        self.assertIn("too many filler bars", block)
        self.assertIn("technical and impressive", block)
