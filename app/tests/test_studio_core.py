...
class StudioCoreTest(unittest.TestCase):
    ...
    def test_official_model_registry_separates_render_helpers_and_unreleased(self):
        ...
        self.assertNotIn("acestep-5Hz-lm-1.7B", boot_models)
        self.assertNotIn("acestep-5Hz-lm-0.6B", boot_models)
    ...
    def test_ace_step_settings_registry_covers_official_fields(self):
        ...
        self.assertEqual(registry["profiles"]["chart_master"]["models"]["acestep-v15-xl-sft"]["inference_steps"], 50)
