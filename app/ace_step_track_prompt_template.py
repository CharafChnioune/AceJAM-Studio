        ...
        *,
        ...
        blocks = {
            ...
            "ACE_STEP_NON_NEGOTIABLES": {
                ...
                "lyrics_role": "temporal script: concise section/performance tags plus actual lyrics only; studio-quality writing matched to the genre and performer",
                "caption_forbidden": [
                    "lyrics",
                    "section tags",
                    "track headers",
                ...
                "studio_rule": "Rap needs cadence/internal rhyme/bar momentum; sung genres need vowel-friendly emotional clarity; EDM/instrumental should use sparse motifs instead of forced literary verses.",
            },
            ...
            "OUTPUT_SCHEMA": {
                ...
                "strict_rules": [
                    ...
                    "Lyrics must stay under 4096 chars.",
            ...
            "SELF_CHECK": [
                ...
                "Use TagCoverageTool and CaptionIntegrityTool as technical checks for ACE-Step caption shape.",
                "Before final JSON, confirm caption is sound-only under 512 chars and lyrics are section-tagged under 4096 chars.",
                "Before final JSON, confirm escaped \\n does not remain in lyrics.",
            ],
        }
        return "\n\n".join(
