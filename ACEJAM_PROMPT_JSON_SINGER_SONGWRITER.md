# AceJAM Song Prompt - Singer-Songwriter JSON Output

Use this prompt when you want one complete AceJAM singer-songwriter song as a
...
- emotional causality
- clean pronoun logic
- low-cliche lyric density with strong human detail
...
```text
GENRE TARGET: SINGER-SONGWRITER

Build a singer-songwriter record with scene-based writing, emotional clarity,
and strong human detail.

SINGER-SONGWRITER WRITING RULES

1. Verses must show scenes, not only feelings.
2. Cause and effect should be clear: what happened, what changed, what hurts,
   what remains, what is wanted.
3. Keep pronouns and perspective stable enough to follow emotionally.
4. Hooks should feel inevitable, not manufactured.
5. Avoid cliché filler unless deliberately subverted.
6. Leave enough breath and shape for melodic performance.
7. line_intent_map must show memory, realization, confession, plea, detail, or
   payoff per line.

SINGER-SONGWRITER ANALYSIS EXPECTATIONS

- imagery_and_specificity_rules should require concrete scenes, objects, rooms,
  weather, gestures, or physical traces
- cadence_plan should explain breath spacing and melodic line length
- hook_mechanics should explain emotional thesis and why the refrain returns
- rewrite_triggers should flag abstract lines that could belong to any song
