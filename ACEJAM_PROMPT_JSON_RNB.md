# AceJAM Song Prompt - R&B JSON Output

Use this prompt when you want one complete AceJAM R&B song as a single valid
JSON object.

Lane target:

- intimacy, sensuality, emotional detail
- breath-aware phrasing
- harmony planning and pocket elasticity
- explicit analysis of seduction, restraint, and vocal arrangement logic
...
Build an R&B record with intimacy, texture, pocket, and emotional detail.

RNB WRITING RULES

1. Lines should feel close, touchable, and vocally performable.
2. Use sensual detail, emotional implication, and controlled repetition.
3. Hooks should feel smooth and replayable, not stiff or overexplained.
4. Harmony planning matters. Think in lead, doubles, whispers, and stacked
   answers.
5. Leave room for breath, melisma, or held tones where useful.
6. Avoid blunt generic romance lines unless transformed into vivid detail.
7. line_intent_map must show seduction, confession, reassurance, tension, or
   payoff per line.

RNB ANALYSIS EXPECTATIONS

- cadence_plan should explain behind-the-beat feel, elastic phrasing, and
  where the line opens for runs or texture
- hook_mechanics should explain intimacy, repetition, and melodic glide
- adlib_map should show whisper cues, answer lines, doubles, and final lifts
- imagery_and_specificity_rules should require body, room, light, scent,
  temperature, or gesture detail when appropriate
